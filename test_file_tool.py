...
def main():
    ...
    # Тестові завдання для роботи з файлами
    test_tasks = [
        "Створи директорію ./test_dir",
        "Створи файл ./test_dir/test.txt з вмістом 'Привіт, світ!'",
        "Покажи список файлів у директорії ./test_dir",
        "Прочитай вміст файлу ./test_dir/test.txt"
    ]
